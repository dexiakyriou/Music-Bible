...
User Priorit (5/5): Για τον χρήστη αυτή η λειτουργία είναι σημαντική διότι μπορεί να λαμβάνει  e-mail για πληροφορίες που τον αφορούν σχετικά με τις αγορές του και σχετικά με την προσβασιμότητα του στην εφαρμογή . 
...
Description: Κάθε χρήστης έχει την δυνατότητα να επιλέγει την κατηγορία μουσικής που επιθυμεί με τον τίτλο του άλμπουμ, το όνομα του track, τον τραγουδιστή.
